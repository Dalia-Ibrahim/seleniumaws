...
moodle_username = "daliaibrahim"
moodle_password = "Be$tLuck247"
...
city = fake.city()
# country = fake.country() if you want select country
# country = fake.current_country() if you want specific country
description = fake.sentence(nb_words=100)
pic_desc = fake.user_name()
phonetic_name = fake.user_name()
list_of_interests = [new_username, email, city]
